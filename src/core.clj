(ns epicerie.core
  ...
  (:use [epicerie.recettes other-recipes-1]))
...
;; (def fichiers-recettes
;;      (map str
;; 	  (repeat "")
;; 	  (list
;; 	   "autres_recettes_1.clj"
;; 	   "recettes200moins_1.clj"
;; 	   "recettes200_299_1.clj"
;; 	   "recettes300_399_1.clj"
;; 	   "recettes400plus_1.clj"
;; 	   "autres_recettes_2.clj"
;; 	   "recettes200_299_2.clj"
;; 	   "recettes200moins_2.clj"
;; 	   "recettes300_399_2.clj"
;; 	   "recettes400plus_2.clj")))

;; (map load-file fichiers-recettes)
...
(load-file "Semaine2_4_modif.clj")


					; EXEMPLES

;; Produit la liste des ingredients de la semaine 2-4-modif
(print-ingredients "./epicerie.txt" (ingredient-list semaine-2-4-modif))
